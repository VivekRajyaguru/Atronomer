...
dag = airflow.DAG(
    ...
    max_active_runs=1)
with dag:
    execution_date = '2020-03-30' #'{{ ds }}'
    start_date = '2020-03-29' #'{{ ds }}'
    end_date = '2020-03-30' # '{{ next_ds }}'
    dag_config = Variable.get("config", deserialize_json=True)
    log_url = dag_config['LogUri']
    extract_script = dag_config['extract_script_path']
    extract_source = dag_config['extract_source_path']
    extract_destination_bucket = dag_config['extract_destination_bucket_path']
    connection_script = dag_config['connection_script_path']
    connection_destination_bucket = dag_config['connection_destination_bucket_path']
    destination_bucket = dag_config['destination_bucket_path']
    source_bucket = dag_config['source_bucket_path']
        ...
        steps=[
            {
                ...
                "HadoopJarStep": {
                    ...
                    "Args": ["spark-submit", "--deploy-mode", "client",
                                        ...
                                        extract_script,
                                        "--source", extract_source, #"s3://rheemconnectrawdata/history/",
                                        "--destination_bucket", extract_destination_bucket, #"s3://weiyutest/",
        ...
        steps=[
            {
                ...
                "HadoopJarStep": {
                    ...
                    "Args": ["spark-submit", "--deploy-mode", "client",
                                        ...
                                        "--destination_bucket", connection_destination_bucket, #"s3://weiyutest/joined/",
